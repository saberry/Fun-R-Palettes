...
image(volcano, col = funPals[["spStan"]], main = "Stan")

image(volcano, col = funPals[["spKyle"]], main = "Kyle")

image(volcano, col = funPals[["spCartman"]], main = "Cartman")
...
image(volcano, col = funPals[["turboKid2"]], main = "Turbo Kid 2")

image(volcano, col = funPals[["turboKid3"]], main = "Turbo Kid 3")

image(volcano, col = funPals[["beavisButthead"]], main = "Beavis and Butthead")
